...
<div class="relative min-h-300 group">
    <a class="text-white text-center w-full z-30 absolute top-1/2 -translate-y-1/2 left-0 transform transition-all" href="<?php echo $link; ?>">
        <div class="py-8 px-16 opacity-80 rounded-3 bg-primary text-white mb-16 inline-block"><?php echo $tag; ?></div>
        <h1 class="text-32 font-bold"><?php echo $title; ?></h1>
    </a>
    <div class="z-20 inset-0 absolute bg-gradient-to-t from-black to-transparent group-hover:opacity-90 transition-all"></div>
    <div class="z-10 bg-no-repeat bg-fixed bg-top bg-cover inset-0 absolute" style="background-image: url('<?php echo $image; ?>')"></div>
</div>